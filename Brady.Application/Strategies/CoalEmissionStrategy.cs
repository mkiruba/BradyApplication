...
public class CoalEmissionStrategy : IEmissionStrategy<CoalGenerator>
{
    public List<Entities.Output.Day> GetEmissions(CoalGenerator generator, ReferenceData referenceData)
    {
